...
(function() {
  var PythonRequestsCodeGenerator, addslashes;
  ...
  PythonRequestsCodeGenerator.identifier = "com.luckymarmot.PawExtensions.PythonRequestsCodeGenerator";

  PythonRequestsCodeGenerator.title = "Python (Requests)";
